...
export async function solicitarGarcom({
    ...
    if (registrarPedidoEvento) {
        ...
        await addDoc(pedidosRef, {
            ...
            taxaServicoPercentual: typeof taxaServicoPercentual === "number" ? taxaServicoPercentual : null,
            valorServico: typeof valorServico === "number" ? valorServico : null,
            totalComServico: typeof totalComServico === "number" ? totalComServico : null,
            couvertAtivo: Boolean(couvertAtivo),
            valorCouvert: typeof valorCouvert === "number" ? valorCouvert : null,
            status: "assistencia",
            motivo: motivo || "",
            tipo: "garcom",
            evento,
