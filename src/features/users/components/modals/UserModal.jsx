  ...
  return (
    ...
    >
      <div className="p-4 sm:p-6">
        {/* Tabs */}
        <section className="grid grid-cols-1 gap-2 mb-6 bg-gray-100 rounded-lg p-1 sm:grid-cols-2">
          <button
            type="button"
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end sm:space-x-3 sm:gap-0">
              <button
                ...
                onClick={onClose}
                disabled={isLoading}
                className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 disabled:opacity-50 sm:w-auto"
              >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 disabled:opacity-50 sm:w-auto"
              >
                {isLoading
