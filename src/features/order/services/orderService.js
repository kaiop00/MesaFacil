...
export const createPedido = async (idRestaurante, mesaId, items, total, observacoes = "", extraData = {}) => {
    const pedidoItems = items.map((item) => ({
        ...
        descricao: item.descricao || item.observacao || item.itemObservation || "",
        observacao: item.observacao || item.itemObservation || item.descricao || "",
        itemObservation: item.itemObservation || item.observacao || item.descricao || "",
