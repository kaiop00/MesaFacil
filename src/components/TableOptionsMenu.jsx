...
const TableOptionsMenu = ({ onDetail, onFinalize }) => {
    return (
        <div className="absolute right-0 top-10 bg-white rounded-lg shadow-lg border p-2 w-56 z-50">
            ...
            <button
                onClick={onDetail}
                className="font-inter font-[14px] flex items-center w-full px-3 py-2 text-sm text-[#151517] hover:bg-gray-100 rounded"
            >
            ...
            <button
                onClick={onFinalize}
                className="font-inter font-[14px] flex items-center w-full px-3 py-2 text-sm hover:bg-gray-100 rounded"
            >
